...
<html>
<head>
	<title>Al Customer Information</title>
</head>
<body>
	<?php include_once('header.php'); ?>

	<section style="width: 75%; float: left; padding-left: 30px;">
		<legend style="font-weight: bold;font-size: 18px; text-align: center; padding-top: 30px; padding-bottom: 30px;">ALL CUSTOMER INFORMATION</legend>
